          ...
          <div> {this.state.view === 'login' ?
              <Modal trigger={this.props.trigger}>
                <Modal.Header>Log in to Vote, Submit Issues, or Create Stances</Modal.Header>
                   <Modal.Content>
                     <Modal.Description>
                       <Header>Or, <a href='' onClick={(e) => this.changeView(e)}>Sign Up</a> if You Dont Have an Account</Header>
                       <Login />
                     </Modal.Description>
                   </Modal.Content>
                 </Modal>:
...
export default connect(mapStateToProps, actions)(CreateViewModal);
